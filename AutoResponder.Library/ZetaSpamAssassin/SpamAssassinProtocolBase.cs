/*
 * souurce: http://www.codeproject.com/Articles/13106/A-C-Wrapper-for-the-SpamAssassin-Protocol
 */
namespace AutoResponder.Library.ZetaSpamAssassin
{
			...
			*/
				...
				ProtocolType.Tcp ) )
			{
				...
				do
				{
					...
					//LogCentral.Current.LogDebug( string.Format( "Received {0} bytes from SpamAssassin.", received ) );
				...
				{
					//LogCentral.Current.LogWarn( "The received message does not start with 'SPAMD'." );
				}
