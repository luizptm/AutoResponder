...
(function () {
    ...
    d.event.prototype = {
        ...
        preventDefault: function (g) {
            ...
            else h.returnValue = false; if (g) this.stopPropagation();
        },
        ...
        a.htmlParser.fragment.fromHtml = function (q, r, s) {
            ...
            function C(D, E, F) {
                ...
                if (r && (!E.type || E.name == 'body')) {
                    ...
                    else H = D.name; if (H && !(H in f.$body || H == 'body' || D.isOrphan)) {
                        x = E;
                        t.onTagOpen(r, {});
                        D.returnPoint = E = x;
                    }
    ...
    (function () {
        function l(s, t) {
            ...
            else A = I; if (this.current) v = this.current[D](false, C, A);
            else {
                if (s) {
                    v = x;
                    if (v.type == 1)
    ...
    (function () {
        ...
        d.range.prototype = {
            ...
            insertNode: function (u) {
                ...
                else v.append(u); if (u.getParent().equals(y.endContainer)) y.endOffset++;
                y.setStartBefore(u);
            },
        ...
        j.list = {
            listToArray: function (N, O, P, Q, R) {
                ...
                for (var S = 0, T = N.getChildCount(); S < T; S++) {
                    ...
                    } else V.grandparent = R; if (O) h.setMarker(O, U, 'listarray_index', P.length);
                    P.push(V);
    ...
    (function () {
        ...
        function C(G, H, I) {
            ...
            if (!I) {
                ...
                else M.$.rowSpan = Y; if (Y >= P) M.removeAttribute('colSpan');
                else M.$.colSpan = Z;
                    ...
                    E.addMode('wysiwyg', {
                        ...
                        loadData: function (X) {
                            ...
                            if (Z) {
                                ...
                                X = aa + X;
                            } else X = Y.docType + '<html dir="' + Y.contentsLangDirection + '"' + ' lang="' + (Y.contentsLanguage || E.langCode) + '">' + '<head>' + '<title>' + G + '</title>' + ac + ab + '</head>' + '<body' + (Y.bodyId ? ' id="' + Y.bodyId + '"' : '') + (Y.bodyClass ? ' class="' + Y.bodyClass + '"' : '') + '>' + X + '</html>'; if (b.gecko) X = X.replace(/<br \/>(?=\s*<\/(:?html|body)>)/, '$&<br type="_moz" />');
                            X += V;
                            this.onDispose();
                            U(X);
                        },
    ...
    (function () {
            ...
            this.on('show', function () {
                ...
                if (Q.config.dialog_startupFocusTab && ag._.pageCount > 1) {
                    ...
                    if (S.onFocus) {
                        ...
                        aq && aq.focus();
                    } else aj(1); if (au._.editor.mode == 'wysiwyg' && c) {
        ...
        a.dialog.prototype = {
            ...
            show: function () {
                ...
                else Q.setStyle('display', 'block'); if (b.gecko && b.version < 10900) {
        ...
        function A(Q) {
            ...
            function X(Z) {
                ...
                else ag = S.x; if (S.y + W[0] < V) ah = -W[0];
            ...
            k.dialog = {
                uiElement: function (Q, R, S, T, U, V, W) {
                    ...
                    var X = (T.call ? T(R) : T) || 'div',
                        Y = ['<', X, ' '],
                        Z = (U && U.call ? U(R) : U) || {}, aa = (V && V.call ? V(R) : V) || {}, ab = (W && W.call ? W.call(this, Q, R) : W) || '',
                    ...
                    var V = this._.children = R,
                        ...
                        Y = {}, Z, aa = function () {
                            ...
                            for (Z = 0; Z < S.length; Z++) {
                                ...
                                } else ae.push('width:' + Math.floor(100 / S.length) + '%'); if (X) ae.push('height:' + m(X));
            ...
            if (T.collapsed) {
                ...
                while (!ag.equals(ad)) {
                    ...
                    if (ag.type == 1 && this.checkElementRemovable(ag)) {
                        ...
                        else H(ag, N(this)[ag.getName()]); if (ah.type == 1 && ah.contains(V)) {
                            af();
                            ah = V.getNext();
                        }
                    }
                ...
                showBlock: function (p, q, r, s, t) {
                    ...
                    e.setTimeout(function () {
                        var E = e.bind(function () {
                            ...
                            } else F.removeStyle('height'); if (A) B -= w.$.offsetWidth;
                ...
                _: {
                    ...
                    getClick: function () {
                        if (!this._.click) this._.click = e.addFunction(function (m) {
                            ...
                            else o.mark(m); if (o.onClick) o.onClick(m, n);
                        }, this);
                        return this._.click;
                    }
                },
