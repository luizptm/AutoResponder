...
function Usuarios() {
	...
	if (id != "") {
		$.ajax({
		    //url: "/MainSite/Usuarios/", data: { 'SendingList': id, 'user_name': user_name },
		    url: "/MainSite/Usuarios/?SendingList=" + id + "&user_name=" + user_name,
			success: function (data, textStatus, jqXHR) {
			    $("#usuarios").html(data);
			},
			error: function (data, textStatus, jqXHR) {
...
function Templates() {
    ...
    if (id != "") {
        $.ajax({
            url: "/MainSite/Templates/", data: { 'SendingList': id },
            success: function (data, textStatus, jqXHR) {
                $("#templates").html(data);
            },
            error: function (data, textStatus, jqXHR) {
...
function Envios() {
	...
	if (id != "") {
		$.ajax({
		    //url: "/MainSite/Envios/", data: { 'SendingList': id, 'user_name': user_name, Open: Open, Unsubscribe: Unsubscribe, Bounce: Bounce, Click: Click },
		    url: "/MainSite/Envios/?SendingList=" + id + "&user_name=" + user_name + "&Open=" + Open + "&Unsubscribe=" + Unsubscribe + "&Bounce=" + Bounce + "&Click=" + Click,
			success: function (data, textStatus, jqXHR) {
			    $("#envios").html(data);
			},
			error: function (data, textStatus, jqXHR) {
...
function exibirMensagem(data, modalId) {
	...
	if (modalId != undefined && data.Status == "1") {
	    ...
	    else if (modalId == "CreateLista") {
	        RefreshListas();
	    }
	    else if (modalId == "CreateTag") {
	        var request = $.ajax({ url: "./MainSite/GetTags", type: "GET" });
	        request.done(function (data) {
	            $("#TagId").html("");
	            $("#TagId").append(data);
	            $('.selectpicker').selectpicker('render');
...
function ShowCreateTemplate(sequence) {
    ...
    $.ajax({
        type: "GET", url: "/MainSite/CreateTemplate/?listId=" + listId,
        success: function (data, textStatus, jqXHR) {
            $("#templates").html(data);
        },
        error: function (data, textStatus, jqXHR) {
...
function ShowEditTemplate(id) {
    $.ajax({
        type: "GET", url: "/MainSite/EditTemplate/" + id,
        success: function (data, textStatus, jqXHR) {
            $("#templates").html(data);
        },
        error: function (data, textStatus, jqXHR) {
    ...
    $.ajax({
        ...
        success: function (data, textStatus, jqXHR) {
            if (data.Status == "0") {
                ...
                //$("#CreateTemplate").attr("class", "modal fade");
